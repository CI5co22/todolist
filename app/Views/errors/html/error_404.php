    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item"><a href="./" class="nav-link text-white" aria-current="page"><i class="fa-solid fa-home"></i> Inicio</a></li>
...
<main class="bg-body-tertiary  container-fluid main" style="min-height: 55vh">
    
<div class="wrap" style="height:20rem; display:grid; place-items:center">
        <h1 class="mb-0 p-0">Error 404 </h1>
        <h5>Lo sentimos, no encontramos esta página <i class="fa-solid fa-gas-pump"></i><i class="ms-2 fa-regular fa-face-frown-open"></i> </h5>
    </div>               
</main>
